...
public class UsuarioRestController {
	...
	public ResponseEntity<?> create(@Valid @RequestBody Usuario usuario, BindingResult result) {
		System.out.println("entra a " + usuario.getCargo());
		...
		try {
			clienteNew = clienteService.save(usuario);
		} catch(DataAccessException e) {
			response.put("mensaje", "Error al realizar el insert en la base de datos");
			response.put("error", "El correo ya se encuentra registrado");
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.INTERNAL_SERVER_ERROR);
		}
	...
	public ResponseEntity<?> update(@Valid @RequestBody Usuario cliente, BindingResult result, @PathVariable Long id) {

		Usuario clienteActual = clienteService.findById(id);

		Usuario clienteUpdated = null;
		...
		try {
			...
			System.out.println(cliente.getCargo().getNombre());
